...
'fonts' => [
    'NotoSansTamil' => [
        'normal' => storage_path('fonts/NotoSansTamil-Regular.ttf'),
        'bold' => storage_path('fonts/NotoSansTamil-Regular.ttf'),
        'italic' => storage_path('fonts/NotoSansTamil-Regular.ttf'),
        'bold_italic' => storage_path('fonts/NotoSansTamil-Regular.ttf'),
    ],
],
