																			...
																			<div class="form-group row mt-2">
																				...
																				<div class="col-sm-8">
																					<div class="input-group">
																						...
																						<input type="date" name="date" id="date" class="form-control input-sm" placeholder="Date" value="{{old('date',$data->date)}}">
																					</div>
																					@if($errors->has('date'))
																			...
																			<div class="form-group row mt-2">
																				...
																				<div class="col-sm-8">
																					<div class="input-group">
																						...
																						<input type="text" name="application_no" class="input-sm form-control" placeholder="Application No" value="{{old('application_no',$data->application_no)}}">
																					</div>
																			...
																			<div class="form-group row mt-2">
																				...
																				<div class="col-sm-8">
																					<div class="input-group">
																						...
																						<input type="text" name="mobile" class="form-control input-sm" placeholder="Mobile Number" value="{{old('mobile',$data->mobile)}}">
																					</div>
																			...
																			<div class="form-group row mt-2">
																				...
																				<div class="col-sm-8">
																					<div class="input-group">
																						...
																						<input type="text" name="name" class="form-control input-sm" placeholder="Name" value="{{old('name',$data->name)}}">
																					</div>
																					@if($errors->has('name'))
																						<span class="form-text form-danger fwb">
																			...
																			<div class="form-group row mt-2" id="othersField" style="display: none;">
																					...
																					<div class="col-sm-8">
																							<div class="input-group">
																									...
																									<input type="text" name="others" class="form-control input-sm" placeholder="Others" value="{{old('others',$data->others)}}">
																							</div>
																			...
																			<div class="form-group row mt-2">
																				...
																				<div class="col-sm-8">
																					<div class="input-group">
																						...
																						<input type="text" name="id_no" class="form-control input-sm" placeholder="ID No" value="{{old('id_no',$data->id_no)}}">
																					</div>
																					@if($errors->has('id_no'))
																						<span class="form-text form-danger fwb">
																			...
																			<div class="form-group row mt-2">
																				...
																				<div class="col-sm-8">
																					<div class="input-group">
																						...
																						<input type="text" name="remarks" class="form-control input-sm" placeholder="Remarks" value="{{old('remarks',$data->remarks)}}">
																					</div>
