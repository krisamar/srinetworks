                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" name="date" class="form-control input-sm" placeholder="Date" value="{{ old('date', date('Y-m-d')) }}">
                                                    </div>
                                                    @if($errors->has('date'))
                                                        <span class="form-text form-danger text-danger fwb">
                                            ...
                                            <div class="form-group row mt-2" id="mobile_field">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="mobile_number" class="form-control input-sm" placeholder="Mobile Number" value="{{old('mobile_number')}}">
                                                    </div>
                                                ...
                                                <div class="form-group row mt-2">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="acc_no" class="form-control input-sm" placeholder="Account Number" value="{{old('acc_no')}}">
                                                        </div>
                                                ...
                                                <div class="form-group row mt-2">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="ifsc" class="form-control input-sm" placeholder="IFSC Code" value="{{old('ifsc')}}">
                                                        </div>
                                                        @if($errors->has('ifsc'))
                                                            <span class="form-text text-danger fwb">
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name" class="form-control input-sm" placeholder="Name" value="{{old('name')}}">
                                                    </div>
                                                    @if($errors->has('name'))
                                                        <span class="form-text form-danger text-danger fwb">
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="amount" class="form-control input-sm" placeholder="Amount" value="{{old('amount')}}">
                                                    </div>
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="sender_name" class="form-control input-sm" placeholder="Sender Name" value="{{old('sender_name')}}">
                                                    </div>
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="sender_mobile" class="form-control input-sm" placeholder="Sender Mobile Number" value="{{old('sender_mobile')}}">
                                                    </div>
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="remarks" class="form-control input-sm" placeholder="Remarks" value="{{old('remarks')}}">
                                                    </div>
